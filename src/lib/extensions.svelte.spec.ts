...
import { catalogExtensions } from './catalogExtensions';
import { getCurrentExtension, setCurrentExtension } from './extensions.svelte';
...
describe('check catalog', () => {
  ...
  test('check check we have extensions in the catalog', async () => {
